...
'password_vault', 'password_vault_labels');
	...
	function label1() {
		...
		echo "<input type='checkbox' value='checked' name='password_vault[label1_req]' {$this->clean_from_db($options['label1_req'])}> Is Required?";
	}
	...
	function label2() {
		...
		echo "<input type='checkbox' value='checked' name='password_vault[label2_req]' {$this->clean_from_db($options['label2_req'])}> Is Required?";
	...
	function label3() {
		...
		echo "<input type='checkbox' value='checked' name='password_vault[label3_req]' {$this->clean_from_db($options['label3_req'])}> Is Required?";
	}
	...
	function label4() {
		...
		echo "<input type='checkbox' value='checked' name='password_vault[label4_req]' {$this->clean_from_db($options['label4_req'])}> Is Required?";
	}
	...
	function label5() {
		...
		echo "<input type='checkbox' value='checked' name='password_vault[label5_req]' {$this->clean_from_db($options['label5_req'])}> Is Required?";
	}
	...
	function settings_validate($input) {
		if (!$input['label1']) {
			...
			$input['label1_req'] = $this->clean_from_db($input['label1_req']);
		}
		if (!$input['label2']) {
			$input['label2_req']='';
		} else {
			$input['label2_req'] = $this->clean_from_db($input['label2_req']);
		} 
		if (!$input['label3']) {
			$input['label3_req']='';
		}  else {
			$input['label3_req'] = $this->clean_from_db($input['label3_req']);
		}
		if (!$input['label4']) {
			$input['label4_req']='';
		} else {
			$input['label4_req'] = $this->clean_from_db($input['label4_req']);
		}
		if (!$input['label5']) {
			$input['label5_req']='';
		}  else {
			$input['label5_req'] = $this->clean_from_db($input['label5_req']);
		}
